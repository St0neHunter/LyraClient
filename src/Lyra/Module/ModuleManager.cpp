...
void ModuleManager::initModules() {
    ...
    // this->addModule(std::make_shared<Keystroke>(Keystroke())); //TODO:
    ...
    // this->addModule(std::make_shared<ArmorStats>(ArmorStats())); //TODO:
    ...
    //this->addModule(std::make_shared<CustomChat>(CustomChat())); //TODO:
